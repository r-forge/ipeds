twelveMonthEnrollment <- function(data, mappings=NULL, institutionId=NA, institutionName=NA, documentId='a', createdDate=format(Sys.time(), '%Y-%m-%dT%H:%M:%S'), noteMessage=NA, transmissionType='Original', documentType='Application', reportingPeriod='July-June', undergraduateContactHours=NULL, undergraduateCreditHours=NULL, graduateCreditHours=NULL) {
